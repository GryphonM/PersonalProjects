...
typedef void(*MapCollisionEventHandler)(GameObject& object,	const MapCollision& sides);
...
public:
	...
	// Component pointers
	// These are PUBLIC because when in a derived class method
	// you cannot access them on a base class reference.
	Transform* transform;
	RigidBody* rigidBody;
